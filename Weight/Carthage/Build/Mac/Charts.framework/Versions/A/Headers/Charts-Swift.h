...
@import AppKit.NSMagnificationGestureRecognizer;
...
- (NSColor * _Nonnull)colorAt:(NSInteger)index;
- (void)resetColors;
...
@property (nonatomic, strong) NSFont * _Null_unspecified infoFont;
@property (nonatomic, strong) NSColor * _Null_unspecified infoTextColor;
...
@interface BarLineChartViewBase : ChartViewBase <BarLineScatterCandleBubbleChartDataProvider, NSGestureRecognizerDelegate>
...
- (CGSize)getMaximumEntrySize:(NSFont * _Nonnull)font;
- (NSString * _Nullable)getLabel:(NSInteger)index;
- (CGSize)getFullSize:(NSFont * _Nonnull)labelFont;
...
@interface CombinedChartView : BarLineChartViewBase <LineChartDataProvider, BarChartDataProvider, ScatterChartDataProvider, CandleChartDataProvider, BubbleChartDataProvider>
...
- (NSColor * _Nullable)getCircleColor:(NSInteger)index;
...
@property (nonatomic, strong) NSColor * _Nonnull circleHoleColor;
...
@interface NSClickGestureRecognizer (SWIFT_EXTENSION(Charts))
- (NSInteger)nsuiNumberOfTouches;
@property (nonatomic) NSInteger nsuiNumberOfTapsRequired;
@end


@interface NSFont (SWIFT_EXTENSION(Charts))
@property (nonatomic, readonly) CGFloat lineHeight;
@end


@interface NSImage (SWIFT_EXTENSION(Charts))
@property (nonatomic, readonly) CGImageRef _Nullable CGImage;
@end


@interface NSMagnificationGestureRecognizer (SWIFT_EXTENSION(Charts))
...
- (NSPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(NSView * _Nullable)inView;
@end


@interface NSPanGestureRecognizer (SWIFT_EXTENSION(Charts))
- (NSInteger)nsuiNumberOfTouches;
...
@interface NSRotationGestureRecognizer (SWIFT_EXTENSION(Charts))
...
@interface NSScreen (SWIFT_EXTENSION(Charts))
@property (nonatomic, readonly) CGFloat nsuiScale;
@end


@interface NSScrollView (SWIFT_EXTENSION(Charts))
@property (nonatomic) BOOL scrollEnabled;
@end


@interface NSTouch (SWIFT_EXTENSION(Charts))

/// Touch locations on OS X are relative to the trackpad, whereas on iOS they are actually on the view.
- (NSPoint)locationInView:(NSView * _Nonnull)view;
@end



@interface NSView (SWIFT_EXTENSION(Charts))
@property (nonatomic, readonly, copy) NSArray<NSGestureRecognizer *> * _Nullable nsuiGestureRecognizers;
@end
